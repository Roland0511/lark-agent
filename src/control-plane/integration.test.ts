...
describe.skipIf(!databaseUrl)("control plane PostgreSQL integration", () => {
  ...
  beforeEach(async () => {
    ...
    await db.updateTable("bots").set({ app_id: config.botAppId, bot_open_id: config.botAppId, display_name: config.agentDisplayName, role_instructions: "", owner_open_id: config.ownerOpenId, attention_model: null, attention_reasoning_effort: null, execution_model: null, execution_reasoning_effort: null, default_executor_id: null, default_workspace_alias: null, enabled: true, is_system: true, config_revision: 1, credential_state: "verified", permission_state: "unchecked", permission_check: null, permission_checked_at: null, deleted_at: null }).where("id", "=", "00000000-0000-0000-0000-000000000001").execute();
